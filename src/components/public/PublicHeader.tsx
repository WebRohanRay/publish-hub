      ...
      <div className="bg-navy text-[11px] text-slate-300 py-1.5 px-4 text-center border-b border-navy-soft/60">
        <div className="max-w-6xl mx-auto flex items-center justify-between text-xs">
          <span className="flex items-center gap-1.5 truncate">
            ...
            <span className="font-semibold text-white">Independent Reviews:</span> We test every app & sportsbook independently.
          </span>
      ...
      <header className="sticky top-0 z-40 w-full border-b border-border/70 bg-paper-public/85 backdrop-blur-md transition-all">
        <div className="mx-auto flex h-18 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            {/* Direct Dashboard Link per Section 1 & 5.1 */}
            <Link
              href="/admin"
        ...
        {/* Mobile dropdown */}
        {mobileMenuOpen && (
          <div className="md:hidden border-b border-border bg-paper-public px-6 py-4 space-y-3">
            <Link
              href="/category/dating"
